...
def run(symbol, timeframe, from_date, to_date, depth, diviation, backstep): #date format to throw in example yyyy.mm.dd (2022.03.27)
  ...
  file_path = "C:/Users/ArKa/AppData/Roaming/MetaQuotes/Terminal/4D4B4D4E14CC1434F986FD62C448B847/tester/files/"+"SWK_GC_01012020.csv" #this could be the name of what professor declare it in his sexy.mql
  return file_path
